...
export default function Home() {
  ...
  return (
    <main>
      ...
      <div style={{
        height: '4px',
        background: 'linear-gradient(90deg, var(--signal-amber) 0%, var(--signal-amber) 60%, var(--draft-blue) 60%, var(--draft-blue) 80%, var(--evidence-green) 80%, var(--evidence-green) 100%)',
      }} />
      ...
      <section id="cases" style={{ maxWidth: '1100px', margin: '0 auto', padding: '72px 24px 80px' }}>
        ...
        {/* Featured case — full width, more visual weight */}
        <Link href={`/cases/${featured.slug}`} style={{ textDecoration: 'none', display: 'block', marginBottom: '24px' }}>
          <div style={{
            ...
            <div style={{
              ...
              background: 'radial-gradient(ellipse at top right, rgba(196,132,29,0.1) 0%, transparent 70%)',
              pointerEvents: 'none',
            }} />
            <div style={{ padding: '40px 48px', position: 'relative' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '24px', flexWrap: 'wrap' }}>
                <span style={{ fontFamily: 'var(--type-mono)', fontSize: '9px', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--signal-amber)', backgroundColor: 'rgba(196,132,29,0.15)', padding: '3px 8px', borderRadius: '2px' }}>
                  {featured.domain}
                </span>
              ...
              <p style={{ fontFamily: 'var(--type-body)', fontSize: '15px', lineHeight: 1.7, color: 'rgba(245,242,235,0.6)', maxWidth: '560px', marginBottom: '28px' }}>
                {featured.excerpt}
              </p>

              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px' }}>
                <span style={{ fontFamily: 'var(--type-mono)', fontSize: '11px', color: 'var(--evidence-green)', fontWeight: 500 }}>
                  ✓ {featured.outcome}
                </span>
                <span style={{ fontFamily: 'var(--type-mono)', fontSize: '11px', color: 'var(--signal-amber)', letterSpacing: '0.06em', borderBottom: '1px solid rgba(196,132,29,0.4)', paddingBottom: '1px' }}>
                  Read case →
                </span>
              </div>
            </div>
        ...
        <div style={{
          ...
          <p style={{ fontFamily: 'var(--type-body)', fontSize: '14px', color: 'var(--graphite)', lineHeight: 1.6, maxWidth: '500px' }}>
            Implementation notes, benchmark results, integration gotchas. The tools-and-tech counterpart to the cases above.
          </p>
          <Link href="/log" style={{
